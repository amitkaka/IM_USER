							...
							<s:hidden name="noRecords_" id="noRecords_" theme="simple"></s:hidden>							
								<table width="100%" border="0" class="dataTable">
									<tr>
										...
										<th width="16%" class="no_sep">Member Name</th>
										<th width="30%" class="no_sep">Member Number</th>
										<th width="5%" class="no_sep">Edit</th>
										<th width="11%" class="no_sep">Delete</th>
									</tr>
									<s:iterator value="membersList_" status="membersIndex">
										<tr>
											<td class="noRitBdr center"><s:checkbox name="checkbox"
													fieldValue="true" theme="simple"
													id="%{#membersIndex.index}" />
											<s:hidden name="contactId" value="%{#groupsIndex.index}"></s:hidden>		
											</td>
											...
											<td class="noRitBdr bolder"><a href=""><img src="/IM_USER/images/members.png" style="width:35px;"/></a>
											</td>
